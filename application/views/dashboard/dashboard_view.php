								...
								<div class="row align-items-center">
									<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
										<div class="income-data d-flex align-items-center justify-content-xl-start justify-content-between mb-xl-0 mb-3">
											...
											<div>
												<h2 class="font-w600 mb-0 income-value">450 kW</h2>
												<span class=" fs-6 font-w500">Power Consumed</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
							...
							<div class="col-xl-6">
								<div class="card">
									<div class="card-header border-0 pb-0 flex-wrap">
										<h3 class="mb-1">Employee Activity</h3>
